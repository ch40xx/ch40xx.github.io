        ...
        <div>
          <nav className="md:hidden fixed bottom-4 left-1/2 transform -translate-x-1/2 w-4/5 bg-white dark:bg-zinc-900 border border-gray-300 dark:border-zinc-700 rounded-2xl shadow-lg backdrop-blur-sm z-50">
            <div className="flex justify-around items-center py-0 px-2">
              <Link href="/" className="flex flex-col items-center space-y-1 p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors">
...
2
              ...
              <Link href="/projects" className="flex flex-col items-center space-y-1 p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="/about" className="flex flex-col items-center space-y-1 p-2 rounded-xl hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
